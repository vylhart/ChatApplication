...
class PhoneAuthRepositoryImpl(private val auth: FirebaseAuth): AuthRepository {
    ...
    override suspend fun beginSignIn(phoneNumber: String, activity: MainActivity): Flow<Resource<Boolean>> = callbackFlow {
    ...
    private fun signInWithPhoneAuthCredential(credential: PhoneAuthCredential): Flow<Resource<Boolean>> = callbackFlow{
